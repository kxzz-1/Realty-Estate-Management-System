...
public class SearchForm {
    ...
    public SearchForm(MainApp mainApp,PropertyManagement propertyManagement) {
        ...
        Label searchByPriceLabel = new Label("Search by Price");
        ...
        searchButton.setOnAction(e -> {
            ...
            try {
                ...
                foundProperties = new ArrayList<>(mainApp.retrievePropertiesByPrice(minPrice, maxPrice));
                //ArrayList<Properties> fProperties = new ArrayList<>(new HashSet<>(foundProperties));

                mainApp.showPropertiesDisplayScreen(foundProperties);
